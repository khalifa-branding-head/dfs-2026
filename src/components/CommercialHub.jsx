...
import { Building2, Trophy, Newspaper, Sparkles } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-6 border-b border-slate-200">
          <div className="space-y-1.5 text-left">
            <div className="inline-flex items-center gap-2 bg-[#0284C7]/10 text-[#0284C7] text-[10px] font-black tracking-[0.25em] px-3.5 py-1 rounded-md uppercase border border-[#0284C7]/20">
              ...
              <span>Commercial & Media Command Hub</span>
            </div>
            <h2 className="text-[#0F172A] text-2xl md:text-4xl font-bold tracking-tight">
              Ecosystem, Venture & Media Highlights
            </h2>
          </div>

          {/* Tab Selection Switches */}
          <div className="flex flex-wrap items-center bg-slate-200/80 p-1.5 rounded-2xl border border-slate-300/60 shadow-inner gap-1">
            <button
            ...
            >
              ...
              <span>Exhibition & Ecosystem</span>
            </button>
            ...
            >
              ...
              <span>FinTech World Cup ($1M+)</span>
            </button>
