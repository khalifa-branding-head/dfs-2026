...
const EXHIBITORS_DATA = [
  { name: 'Exhibitor Brand Ltd', booth: 'Pavilion A - Booth 23' },
];
      ...
      <section className="py-16">
        <div className="max-w-[1300px] mx-auto px-6 md:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {EXHIBITORS_DATA.map((exhibitor, idx) => (
              <motion.article
                whileHover={{ y: -5 }}
                key={idx}
              ...
              >
                ...
                <p className="text-brand-text-muted text-xs mt-2 font-semibold">
                  Booth Area: {exhibitor.booth}
                </p>
              </motion.article>
            ))}
          </div>
